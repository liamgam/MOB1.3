...
func add(newGuest: Guest, specialRequest: (Int) -> ()) {
 ...
 func remove(guest: Guest, peopleLeft: ([Guest]) -> ()) {
    let people = listOfGuests.filter {$0 != guest}
    peopleLeft(people)
 }
/*:
...
add(newGuest: eric) { (guestNumber: Int) in
 ...
 let pie = Guest(name: "Pie", age: 21)
 add(newGuest: pie) { (guestNumber: Int) in
    print("There are \(guestNumber - 1) guests ahead of me")
    print("play rock music")
 }
 ...
 remove(guest: pie) { (guests: [Guest]) in
    print("number of guests left include: \(guests)")
 }
 
 let rin = Guest(name: "Rinni", age: 19)
 add(newGuest: rin) { (guestNumber: Int) in
    print("There are \(guestNumber - 1) guests ahead of me")
    print("play rock music")
 }
